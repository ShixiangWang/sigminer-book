...
The book is written as a guide for extracting, analyzing and visualizing mutational signatures with R/CRAN package **sigminer**. In this book, we assume you have already known how to operate [R](http://cran.r-project.org/).
